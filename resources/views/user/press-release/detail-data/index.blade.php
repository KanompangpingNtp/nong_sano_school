            ...
            <div id="carouselExampleIndicators" class="carousel slide">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                        <img src="{{ asset('storage/' . $photo->post_photo_file) }}" class="d-block w-100" alt="Image {{ $index + 1 }}">
                    </div>
                    @endforeach
                </div>
                    ...
                    <div class="tab-pane fade" id="tab2-content" role="tabpanel" aria-labelledby="tab2-tab">
                        <div class="p-4 card-text">
                            ...
                            <p class="fs-4">
                                ...
                                @if($pressRelease->pdfs->first() && $pressRelease->pdfs->first()->post_pdf_file)
                                <embed src="{{ asset('storage/' . $pressRelease->pdfs->first()->post_pdf_file) }}" width="100%" height="600px" type="application/pdf">
                                @else
                                <p>ไม่ได้แนบไฟล์ประกอบ</p>
                                @endif
                            </p>
                        </div>
                    </div>
